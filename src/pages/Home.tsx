        ...
        <div className="bg-bg-active overflow-x-hidden">
            ...
            <div className="flex flex-col mt-[98px] text-center">
                ...
                <div className="flex container self-center mt-20 relative">
                    <div className="border-[#F5B30D] border-[3px] rounded-[42px] max-md:px-4 px-20 py-24 w-full max-md:mx-10 mx-16 ">
                        <div className="flex xl:flex-row flex-col">
                ...
                <div className="relative">
                    ...
                    <div className="absolute top-0 left-[-240px] hidden xl:flex">
                ...
                <div className="flex xl:mb-40 flex-col xl:flex-row gap-x-10 gap-y-10 mt-10 xl:items-center items-end">
                    ...
                    <div className="image2 w-full -mr-14">
                        <img src={human3} alt="human" className="cover w-[800px] float-end"></img>
                    </div>
                </div>
                <div className="flex container self-center mt-20 mb-40 relative">
                    <div className="border-[#F5B30D] border-[3px] rounded-[42px] w-full mx-5 sm:mx-16 flex flex-col items-center text-center">
                        <div className="font-spicy sm:text-[62px] text-[40px] text-[#F5B30D]  sm:px-20  pt-24 ">
                            JOIN $MEME COMMUNITY
                        </div>
